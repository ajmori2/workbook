...
function main() {
    ...
    d3.json('/static/mp_SimpleAliceInWonderland/data.json', 
            function(data) {
...
function histogram(id, data) {
    ...
    var x = d3.scale.linear()
              ...
              .range([0, width]);
    // We also want a scale for our y-axis so we can make the height of 
    // the bars relative to the largest bar in our dataset
